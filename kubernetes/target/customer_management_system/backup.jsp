...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <a class="navbar-brand" href="#page-top">Customer Management System</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#download">Login</a>
                </li>
                <li class="nav-item">
    ...
    <section id="about" class="content-section text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <h2>About Customer Management System</h2>
                    <p>Grayscale is a free Bootstrap theme created by Start Bootstrap. It can be yours right now, simply download the template on <a href="http://startbootstrap.com/template-overviews/grayscale/">the preview page</a>. The theme is open source, and you can use it for any purpose, personal or commercial.</p>
    ...
    <section id="download" class="">
        <div class="container">
            	...
            	<div class="row-fluid">
            		<div class="col-md-8">
            			<h2>Login</h2>
                		<p>Login now to keep track of your points</p>
            		</div>
            		<div class="col-md-4">
            			<h2>Login</h2>
                		<p>Login now to keep track of your points</p>
